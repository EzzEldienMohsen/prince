  ...
  return (
    <div className="w-full lg:w-1/2 flex flex-col items-start justify-center mt-4 lg:mt-0 gap-y-4">
      <div className="w-full flex flex-col justify-center items-start gap-y-4 ">
        ...
        <h1 className="text-black font-tajawal font-medium text-2xl md:text-3xl lg:text-2xl">
          {t('mainPageTitle')}
        </h1>
        ...
        <p
          className={`text-[#7C8893] font-tajawal font-normal md:text-sm ${isArabic?"mr-4":"ml-4"} `}
