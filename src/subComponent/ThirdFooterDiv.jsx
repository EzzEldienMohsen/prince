...
const ThirdFooterDiv = () => {
  ...
  return (
    <div className="w-full  pb-8 bg-theDGray flex font-normal justify-evenly px-8 lg:px-16 items-center">
      <div className="border-t-[2px] border-theLGray px-4 lg:px-0 w-full gap-y-4 md:gap-y-0 md:w-[96vw]  py-3 md:py-6  flex flex-col justify-center items-center md:flex-row md:justify-between ">
